  ...
  for (const rr of rrset) {
    ...
    switch (r.type) {
      ...
      case types.PX:
        ...
        break;
      case types.NXT:
        x.nextDomain = x.nextDomain.toLowerCase();
        break;
      case types.SRV:
        x.target = x.target.toLowerCase();
        break;
      ...
      //     if (opt.code === options.CHAIN)
      //       opt.option.trustPoint = opt.option.trustPoint.toLowerCase();
      //   break;
      // case types.IPSECKEY:
      //   if (x.gatewayType === 3)
      //     x.target = x.target.toLowerCase();
      ...
      case types.NSEC:
        ...
        break;
      // case types.HIP:
      //   for (let i = 0; i < x.servers.length; i++) {
      //     const name = x.servers[i];
      //     x.servers[i] = name.toLowerCase();
      //   }
      //   break;
      // case types.TALINK:
      //   x.prevName = this.prevName.toLowerCase();
      //   x.nextName = this.nextName.toLowerCase();
      //   break;
      // case types.LP:
      //   x.fqdn = x.fqdn.toLowerCase();
      //   break;
      // case types.TKEY:
      //   x.algorithm = x.algorithm.toLowerCase();
      //   break;
      // case types.TSIG:
      //   x.algorithm = x.algorithm.toLowerCase();
      //   break;
