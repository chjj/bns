    ...
    for (const option of options) {
      ...
      switch (name) {
        ...
        case 'ndots': {
          ...
          try {
            dots = util.parseU8(arg);
          } catch (e) {
            continue;
          }

          this.dots = Math.min(15, dots);
        ...
        case 'timeout': {
          ...
          try {
            timeout = util.parseU8(arg);
          } catch (e) {
            continue;
          }

          this.timeout = Math.min(30, timeout);
        ...
        case 'attempts': {
          ...
          try {
            attempts = util.parseU8(arg);
          } catch (e) {
            continue;
          }

          this.attempts = Math.min(5, attempts);
