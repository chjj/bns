...
const schemas = {
  ...
  DS: DSSchema,
  SSHFP: SSHFPSchema,
  IPSECKEY: IPSECKEYSchema,
  RRSIG: RRSIGSchema,
  NSEC: NSECSchema,
  DNSKEY: DNSKEYSchema,
  DHCID: DHCIDSchema,
  NSEC3: NSEC3Schema,
  NSEC3PARAM: NSEC3PARAMSchema,
  TLSA: TLSASchema,
  SMIMEA: SMIMEASchema,
  HIP: HIPSchema,
  NINFO: NINFOSchema,
  ...
  TALINK: TALINKSchema,
  CDS: CDSSchema,
  CDNSKEY: CDNSKEYSchema,
  OPENPGPKEY: OPENPGPKEYSchema,
  CSYNC: CSYNCSchema,
  SPF: SPFSchema,
  UINFO: UINFOSchema,
  UID: UIDSchema,
...
const oschemas = {
  ...
  EXPIRE: EXPIRESchema,
  COOKIE: COOKIESchema,
  TCPKEEPALIVE: TCPKEEPALIVESchema,
  PADDING: PADDINGSchema,
  TRIEROOT: TRIEROOTSchema,
  LOCAL: LOCALSchema,
  LOCALSTART: LOCALSchema,
  LOCALEND: LOCALSchema
};
...
exports.schemasByVal = schemasByVal;
exports.oschemas = oschemas;
exports.oschemasByVal = oschemasByVal;
