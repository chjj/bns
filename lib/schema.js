...
// We need a list of assigned numbers/names
// to actually present this. It appears as:
//   WKS [address] [protocol-name] ( proto1 proto2 etc )
// Bitmap is a map of ports. Bit 0 is port 0,
// bit 1 is port 1, etc.
const WKSSchema = [
  ['address', INET4],
  ['protocol', U8],
