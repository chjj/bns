...
class SIGRecord extends RecordData {
  ...
  validityPeriod(t) {
    ...
    const modi = Math.floor((this.inception - t) / YEAR68);
    const mode = Math.floor((this.expiration - t) / YEAR68);

    const ti = this.inception + (modi * YEAR68);
    const te = this.expiration + (mode * YEAR68);
