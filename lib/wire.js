...
class EDNS extends bio.Struct {
  ...
  getJSON() {
    ...
    return {
      ...
      size: this.size,
      code: ecodesByVal[this.code] || 'UNKNOWN',
...
class Record extends bio.Struct {
  ...
  fromString(str) {
    ...
    let cls = short[parts[2]];

    if (cls == null && types[parts[2]] != null) {
      parts.splice(2, 0, 'IN');
      cls = classes.INET;
    }
