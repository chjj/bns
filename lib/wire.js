...
class ARecord extends RecordData {
  ...
  read(br) {
    this.address = IP.toString(br.readBytes(4, true));
    return this;
  }
}
...
class AAAARecord extends RecordData {
  ...
  read(br) {
    this.address = IP.toString(br.readBytes(16, true));
    return this;
  }
}
  ...
  read(br) {
    ...
    switch (this.gatewayType) {
      case 0:
        break;
      case 1:
        this.target = IP.toString(br.readBytes(4, true));
        break;
      case 2:
        this.target = IP.toString(br.readBytes(16, true));
        break;
      case 3:
        this.target = readNameBR(br);
        break;
...
class L32Record extends RecordData {
  ...
  read(br) {
    this.preference = br.readU16BE();
    this.locator32 = IP.toString(br.readBytes(4, true));
    return this;
  }
}
